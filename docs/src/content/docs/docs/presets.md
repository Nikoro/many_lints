...
| `recommended` | 91 | 56 | The default choice for most production projects. |
| `opinionated` | 178 | 87 | A coherent Many Lints house style. |
| `pedantic` | 236 | 58 | Maximum uniformity, explicitness, ordering, and structural limits. |
...
- **Testing:** [`prefer_correct_test_file_name`](/many_lints/docs/rules/testing-rules/prefer-correct-test-file-name/)
...
- **State management:** [`avoid_empty_setstate`](/many_lints/docs/rules/state-management/avoid-empty-setstate/), [`avoid_unnecessary_overrides`](/many_lints/docs/rules/state-management/avoid-unnecessary-overrides/), [`avoid_unnecessary_overrides_in_state`](/many_lints/docs/rules/state-management/avoid-unnecessary-overrides-in-state/), [`avoid_unnecessary_stateful_widgets`](/many_lints/docs/rules/state-management/avoid-unnecessary-stateful-widgets/), [`prefer_immutable_state`](/many_lints/docs/rules/state-management/prefer-immutable-state/)
...
- **Testing:** [`format_test_name`](/many_lints/docs/rules/testing-rules/format-test-name/)
