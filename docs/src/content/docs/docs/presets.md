...
| `opinionated` | 177 | 86 | A coherent Many Lints house style. |
| `pedantic` | 234 | 57 | Maximum uniformity, explicitness, ordering, and structural limits. |
