...
| `opinionated` | 185 | `recommended` plus this package's own style preferences. |
...
Beyond `exclude`, `include` and `message`, **122 rules** accept options that change *what*
...
| [`prefer_overriding_parent_equality`](/many_lints/docs/rules/collection-type/prefer-overriding-parent-equality/) | `ignored_types`, `additional_ignored_types` |
...
| [`match_pattern`](/many_lints/docs/rules/code-quality/match-pattern/) | `patterns` |
