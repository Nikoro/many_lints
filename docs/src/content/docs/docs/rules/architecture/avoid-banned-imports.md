...
- [`avoid_banned_exports`](/many_lints/docs/rules/architecture/avoid-banned-exports/) — the same idea for re-exports, configured separately because importing a library for internal use and exposing it to consumers are different decisions
