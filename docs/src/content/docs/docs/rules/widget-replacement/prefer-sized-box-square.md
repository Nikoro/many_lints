...
description: "Use SizedBox.square instead of SizedBox with equal width and height."
sidebar:
  badge:
    text: "Fix"
    variant: "tip"
...
| Property | Value |
|----------|-------|
| **Rule name** | `prefer_sized_box_square` |
...
Try using SizedBox.square(dimension: ...) instead.
