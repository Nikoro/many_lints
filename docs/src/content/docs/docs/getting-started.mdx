...
description: Get started with many_lints — a comprehensive collection of 261 custom lint rules for Flutter & Dart projects.
---
...
`core` plus likely defects and concrete runtime risks), `opinionated` (185 rules — `recommended`
plus this package's own style preferences), `pedantic` (242 rules — strict structure,
